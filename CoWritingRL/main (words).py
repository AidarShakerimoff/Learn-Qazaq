 ...
 # this is a method for assessing a word to a student. Provide a word and wait him/her to rewrite it. Also count time for response
  ...
  def start_episode(self):
    ...
    if len(self.author) > 10:
      ...
      text1 = "Could you please write the following in Kazakh-Latin alphabet: "+ self.word
      text2 = "How this phrase would look like in Kazakh-Latin alphabet: "+ self.word
      text3 = "Please rewrite the following in Kazakh-Latin alphabet: "+ self.word
  ...
  def greet(self, id):
    bot.send_message(self.id, "Hello! Welcome to CoWriting_Qazaq! This chatbot is dedicated to help you effectively learn kazakh-latin alphabet!")
  ...
  def process(self, message):
    ...
    #self.logfile.close()
    temp_dict = {'id': self.info[0], 'total_time': self.info[1], 'interaction_date_and_time': self.info[2], 'num_of_iterations': self.info[3], 'explored_letters': self.info[4], 'problem_letters': self.info[5], 'avg_time_per_iteration': self.info[6], '(time 1-N)': self.info[7]}
